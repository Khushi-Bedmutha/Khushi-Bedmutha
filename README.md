...
- 🌐 [Visit My Portfolio](https://khushi-bedmutha.vercel.app/)
...
- 🔗 [**Biomesh**](https://github.com/Khushi-Bedmutha/Biomesh) — Decentralized platform for secure biometric and medical data using **MERN Stack**, Blockchain, AI/ML.
- 🔗 [**FoodVal**](https://foodval-frontend.onrender.com/) — Waste-to-energy marketplace with **React, Auth0, Stripe** integration.
- 🔗 [**MealsForYou**](https://meals-for-you.vercel.app/) — Meal planning app with voting system for mess services.
- 🔗 [**Prime Study Abroad**](https://prime-study.netlify.app/) — Full-stack education platform built during internship.
...
- 🥉 **IOT Mini Project Competition** — 3rd place
- 🏅 **IIC Winner**
- 🎙 **Maffick Anchoring & Organizing**
- 💼 **CSI KKWIEER Student Chapter Secretary (2024-25)**
